...
class TopRatedFragment : ReactiveView<State, Intent>(),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        bind(TopRatedViewModel::class, sharedWithActivity = true)
        initMovieAdapter()
        ...
        lifecycleScope.launch {
            SortingOptionsByRecommendation.sortingOptionsTopRated.collect {
